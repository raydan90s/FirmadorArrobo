    ...
    public class NotaCreditoController : ControllerBase
    {
        ...
        public async Task<IActionResult> GenerarNotaCredito([FromBody] NotaCreditoRequest request)
        {
            ...
            try
            {
                ...
                // ========================================
                Console.WriteLine("✅ Nota de Crédito RECIBIDA por el SRI");
                ...
                Console.WriteLine("========================================");
                Console.WriteLine($"Clave de acceso: {notaCredito.InfoTributaria.ClaveAcceso}");
                ...
                try
                {
                    auto = await _webService.AutorizacionComprobanteAsync(notaCredito.InfoTributaria.ClaveAcceso);
                ...
                catch (Exception exAuto)
                {
                    ...
                    return BadRequest(new
                    {
                        ...
                        mensaje = "La Nota de Crédito fue recibida pero no se pudo consultar su autorización. Intente consultarla manualmente con la clave de acceso."
                    });
                }
                ...
                {
                    Console.WriteLine("⚠️ Nota de Crédito NO AUTORIZADA");
